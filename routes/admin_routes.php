...
Route::redirect('/', '/ims/login');

Route::redirect('/home', '/ims/admin/dashboard');

Route::redirect('/login', '/ims/login');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::any('user_management/users/profile', 'UsersController@profile')->name('user_management.users.profile');
