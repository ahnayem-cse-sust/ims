...
if (!function_exists("access")) {
    function access($controller = '')
    {
        ...
        if (Gate::denies($access_permission) && empty($controller)) {
            return 0;
        }
...
if (!function_exists("create")) {
    function create($controller = '')
    {
        ...
        if (Gate::denies($create_permission) && empty($controller)) {
            return 0;
        }
...
if (!function_exists("edit")) {
    function edit($controller = '')
    {
        ...
        if (Gate::denies($edit_permission) && empty($controller)) {
            return 0;
        }
...
if (!function_exists("delete")) {
    function delete($controller = '')
    {
        ...
        if (Gate::denies($delete_permission) && empty($controller)) {
            return 0;
        }
...
if (!function_exists("show")) {
    function show($controller = '')
    {
        ...
        if (Gate::denies($show_permission) && empty($controller)) {
            return 0;
        }
