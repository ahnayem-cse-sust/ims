...
@section('content')
<main>
    <form action="/ims/admin/report_management/generate_customer_account" method="get">
                        ...
                        <tbody>
                            ...
                            @endphp
                                <tr>
                                    ...
                                    <td>
                                        <a href="/ims/admin/report_management/view_customer_account?passenger_id={{ $voucher->passenger_id }}" target="_blank" class="btn ripple btn-warning">
