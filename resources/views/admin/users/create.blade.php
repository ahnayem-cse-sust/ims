        ...
        <div class="card border custom-card">
            <div class="card-header custom-card-header">
                <h5 class="main-content-label mb-0">
                    @if(!isset($user)) {{ trans('cruds.create') }} @else {{ trans('cruds.update') }} @endif
                    {{ trans('cruds.user') }}
                </h5>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('user_code') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="user_code" name="user_code" data-model="User" data-prefix="EMP"
                                    data-update_id="{{ isset($user) ? $user->user_code : 0 }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->has('roles') ? 'has-error' : '' }}">
                                ...
                                <select name="roles[]" id="roles" class="form-control select2" {{ $disabled }} required>
                        ...
                        <div class="col-md-4 d-none">
                            <div class="form-group {{ $errors->has('acl') ? 'has-error' : '' }}">
                                <label for="acl">{{ trans('cruds.acl') }} (<span class="required">*</span>)
                                    <span class="btn btn-info btn-xs select-all">{{ trans('cruds.select_all') }}</span>
                                    <span
                                        class="btn btn-info btn-xs deselect-all">{{ trans('cruds.deselect_all') }}</span>
                                </label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('section_id') ? 'has-error' : '' }}">
                                <label for="section_id">{{ trans('cruds.section') }} (<span class="required">*</span>)
                                </label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                                ...
                                <input type="password" id="password" name="password"
                                    value="{{ isset($user)?$user->human_password:'' }}" class="form-control" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="btn btn-danger float-start mt-4" type="submit"
                                value="{{ trans('cruds.save') }}">
                        </div>
                    </div>
                </form>
            </div>
...
$(document).on('change', '#acl_country', function(params) {
    ...
    acl = $('#acl');
    url = window.base+'/admin/user_management/users/get_acl_office';
