...
$(document).on('click', '.btnAddNew', function() {
    let requisition_code, requisition_date, job_id, party_id, branch_id, section_id, warehouse_id,
        requisition_item_id, select_item, item_id, item_name, item_code, group_id, group_name, subgroup_id,
    ...
    if (!requisition_code || !requisition_date || !branch_id || !section_id || !warehouse_id || !item_id || !
        quantity) {
        SWAL_ALERT("", "");
        return false;
    }
...
$(document).on('click', '.editRow', function() {
    let requisition_item_id, group_id, subgroup_id, item_id = 0,
        unit_id, sale_price, tr;
    tr = $(this).closest('tr');
    prev_tr = tr;
