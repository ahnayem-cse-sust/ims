                            ...
                            <tr data-entry-id="{{ $requisition->id }}">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-primary"
                                        href="{{ route('admin.requisition.show', $requisition->id) }}"
                                    ...
                                    <a class="btn btn-xs btn-info"
                                        href="{{ route('admin.requisition.edit', $requisition->id) }}"
                                        data-placement="top" data-toggle="tooltip" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    @endif

                                    <!-- href="/ims/admin/section_requisition_management/requisition/approved/{{ $requisition->id }}" -->
                                    @if(delete())
                                    <a class="btn btn-xs btn-warning"
                                    href="{{ route('admin.section_requisition_management.requisition.approved', $requisition->id) }}"
                                    data-placement="top" data-toggle="tooltip" title="Click to Approved Requisition"
                                        onclick="return confirm('{{ trans('cruds.areYouSure') }}');">
                                        <i class="fas fa-refresh"></i>
                                    </a>
                                    @endif

                                    @if(delete())
                                    <form action="{{ route('admin.requisition.destroy', $requisition->id) }}"
                                        method="POST" onsubmit="return confirm('{{ trans('cruds.areYouSure') }}');"
                                        style="display: inline-block;">
                                        <input type="hidden" name="_method" value="DELETE">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <button type="submit" class="btn btn-xs btn-danger" data-placement="top"
