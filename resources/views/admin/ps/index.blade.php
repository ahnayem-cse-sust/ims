                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $ps->id }}">
                                ...
                                <td>
                                    ...
                                    @if(edit())
                                    <a class="btn btn-xs btn-warning" href="/ims/admin/main_warehouse_management/ps/approved/{{ $ps->id }}" data-placement="top" data-toggle="tooltip" title="Click to Approved PS">
