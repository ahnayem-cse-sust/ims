...
<div class="row row-sm">
    <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
        <div class="card border custom-card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.report_management.report.generate-requisition-report') }}" method="GET">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <table class=" table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $requisition->id }}">
                                <td>{{ ($key+1) }}</td>
                                <td>
                                   <!-- <a href="/ims/admin/section_requisition_management/requisition/{{ $requisition->id }}" target="_blank"> -->
                                   <a href="{{ route('admin.section_requisition_management.requisition.approved', $requisition->id) }}" target="_blank">
