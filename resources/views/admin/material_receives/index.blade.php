                            ...
                            <tr data-entry-id="{{ $material_receive->id }}">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-primary"
                                        href="{{ route('admin.material_receive.show', $material_receive->id) }}"
                                    ...
                                    {{--  @if(edit())
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.material_receive.edit', $material_receive->id) }}"
                                    data-placement="top" data-toggle="tooltip" title="Edit">
                                    <i class="fas fa-edit"></i>
                                    </a>
                                    @endif --}}

                                    @if($material_receive->status == 'Pending')

                                    @if(edit())
                                    <a class="btn btn-xs btn-warning"
                                        href="/ims/admin/main_warehouse_management/material_receive/approved/{{ $material_receive->id }}"
                                        data-placement="top" data-toggle="tooltip"
                                        title="Click to Approved Requisition">
                                        <i class="fas fa-refresh"></i>
                                    </a>
                                    @endif

                                    @if(delete())
                                    <form action="{{ route('admin.material_receive.destroy', $material_receive->id) }}"
