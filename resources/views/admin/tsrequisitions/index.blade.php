                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $tsrequisition->id }}">
                                ...
                                <td>
                                    ...
                                    @if(edit())
                                    <a class="btn btn-xs btn-warning" href="/ims/admin/tools_store_management/tsrequisition/approved/{{ $tsrequisition->id }}" data-placement="top" data-toggle="tooltip" title="Click to Approved Requisition">
