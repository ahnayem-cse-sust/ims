...
<div class="row row-sm">
    <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
        <div class="card border custom-card">
            ...
            <div class="card-body">
                <form action="/ims/admin/report_management/generate-product-stock-report" method="GET">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key +1 }}</td>
                                <td>
                                    <a href="/ims/admin/inventory_management/item/{{ $value->id }}" target="_blank">
                                ...
                                {{-- <td class="text-center">
                                    <a href="/ims/admin/report_management/product-stock-report/show-card-details/{{ $value->id }}" target="_blank">
                                        {{ $value->ts }}
                                    </a>
                                </td> --}}
