                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $demageitem->id }}">
                                ...
                                <td>
                                    ...
                                    @endif
                                    @if(edit())
                                    <a class="btn btn-xs btn-warning" href="/ims/admin/tools_store_management/demageitem/approved/{{ $demageitem->id }}" data-placement="top" data-toggle="tooltip" title="Click to Approved Requisition">
