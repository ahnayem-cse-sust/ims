                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $tsitemissue->id }}">
                                ...
                                <td>
                                    ...
                                    @if(edit())
                                    <a class="btn btn-xs btn-warning" href="/ims/admin/tools_store_management/tsitemissue/approved/{{ $tsitemissue->id }}" data-placement="top" data-toggle="tooltip" title="Click to Approved Requisition">
