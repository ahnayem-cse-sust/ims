                ...
                <table class="table1 table-bordered1 table-striped1" style="width:100%">
                    <tbody>
                        <tr>
                            ...
                            <td>: {{ isset($challan)?$challan->challan_code:'' }}</td>
                            <th style="width:150px;">{{ __('cruds.challan_date') }}</th>
                            <td>: {{ isset($challan)?$challan->challan_date:'' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>: {{ isset($challan)?$challan->delivery_man:'' }}</td>
                            <th>{{ __('cruds.delivery_place') }}</th>
                            <td>: {{ isset($challan)?$challan->delivery_place:'' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">: {{ isset($challan)?$challan->description:'' }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <tbody>
                        <tr>
                            <td style="width:20%;text-align:center;">
                                {{ isset($challan->createdBy)?$challan->createdBy->name:'' }}<br /><span>Created
                                    By</span><br></td>
