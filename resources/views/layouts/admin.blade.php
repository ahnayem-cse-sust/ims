...
$section_name = isset($user->section)?$user->section->section_name:'';
}
...
<head>
    ...
    <meta name="description" content="BITAC IMS - BITAC inventory management stystem">
    ...
    <div class="page">
        ...
        <div class="main-header side-header sticky">
            <div class="main-container container-fluid">
                ...
                <div class="main-header-center">
                    ...
                    <div>
                        <h3 class="text-center">{{ $section_name }}</h3>
                    </div>
                </div>
                    ...
                    <div class="navbar navbar-expand-lg navbar-collapse responsive-navbar">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                            <div class="d-flex order-lg-2 ms-auto">
                                ...
                                <div class="dropdown main-header-notification flag-dropdown d-none">
                                ...
                                <div class="dropdown d-flex main-profile-menu">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item border-top"
                                            href="{{ route('admin.user_management.users.profile') }}">
        ...
        <div class="main-footer text-center">
            <div class="container">
                <div class="row row-sm">
                    <div class="col-md-12">
                        <span>Copyright © {{ date('Y') }} <a href="javascript:void(0);">BITAC</a>. Maintained by ICT
                            Department.
