$(document).ready(function () {
    ...
    window.proccessing =
        "<div class='loader'> <div class='loader--dot'></div><div class='loader--dot'></div><div class='loader--dot'></div><div class='loader--dot'></div><div class='loader--dot'></div><div class='loader--dot'></div><div class='loader--text'></div></div>";
    ...
    $(".datepicker-date")
        ...
        $(".datetimepicker")
            .datetimepicker({ format: "yyyy-mm-dd hh:ii:ss", autoclose: !0 })
            .on("keypress", function () {
                return false;
            });
